...
export default function TableOfContents({
  ...
  return (
    <aside
      className={`hidden xl:block w-64 bg-cream dark:bg-deep rounded-xl border border-warm-200 dark:border-warm-800 p-4 shadow-sm ${className}`}
...
export function MobileTOC({
  ...
  return (
    <div className={`xl:hidden ${className}`}>
      <details className="border border-warm-200 dark:border-warm-800 rounded-xl bg-cream dark:bg-deep p-4">
